    ...
    <div className="min-h-screen md:h-screen flex flex-col md:flex-row font-sans md:overflow-hidden">
      ...
      <div className="hidden md:flex flex-col justify-between w-[45%] lg:w-1/2 bg-gray-900 text-white p-8 lg:p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mt-auto mb-auto">
          ...
          <p className="text-lg lg:text-xl text-gray-400 font-medium">
            Create an account to gain access to enterprise-grade link management and analytics.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 bg-[#fafafa] p-6 sm:p-8 flex flex-col overflow-y-auto">
        ...
        <div className="w-full max-w-sm m-auto py-10 md:py-0">
          <div className="mb-6">
            <h2 className="text-2xl lg:text-3xl font-bold tracking-tight text-gray-900 mb-1">Create an account</h2>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[11px] text-gray-400 font-bold uppercase tracking-widest">Or with email</span>
            <div className="h-px bg-gray-200 flex-1"></div>
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label className="text-[11px] font-bold text-gray-900 uppercase tracking-wider mb-1 block">Full Name</label>
              <input 
                type="text" 
                required
                value={name}
            ...
            <div>
              <label className="text-[11px] font-bold text-gray-900 uppercase tracking-wider mb-1 block">Password</label>
              <input 
                type="password" 
                required
                value={password}
