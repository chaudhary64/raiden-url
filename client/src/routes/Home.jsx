      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 w-full max-w-5xl mx-auto">
        <div className="text-center mb-12 max-w-2xl">
          ...
          <p className="text-lg text-gray-500 max-w-xl mx-auto">
            A beautiful, minimal URL shortener. Paste your long link below and we'll make it short and sweet.
          </p>
        </div>
        ...
        <div className="w-full max-w-xl mb-16 flex flex-col sm:flex-row gap-3 px-4 sm:px-0">
          ...
          />
          <Button size="large" className="!rounded-none w-full sm:w-auto shadow-sm">Shorten</Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
          <Card className="flex flex-col items-start gap-3 hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-gray-500 m-0 leading-relaxed">Experience incredibly fast redirects and a snappy interface built for speed and efficiency.</p>
          </Card>
          <Card className="flex flex-col items-start gap-3 hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-gray-500 m-0 leading-relaxed">Your data is safe with us. We use modern encryption to ensure your links are secure.</p>
          </Card>
          <Card className="flex flex-col items-start gap-3 hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-gray-500 m-0 leading-relaxed">Built on reliable infrastructure so your links work perfectly 24/7 without interruption.</p>
          </Card>
        </div>
      </main>

      <footer className="px-6 py-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500 bg-white">
        <div>© 2026 Short.Link. All rights reserved.</div>
        <div className="flex gap-3 items-center">
          <Chip status="default">v1.0.0</Chip>
          <Chip status="active">All systems normal</Chip>
        </div>
      </footer>
    </div>
  );
